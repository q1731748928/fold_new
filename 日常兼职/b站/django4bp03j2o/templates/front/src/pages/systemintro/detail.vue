		...
		<div class="attr" :style='{"padding":"20px 0","position":"relative","order":"1"}'>
			...
			<div class="info" :style='{"padding":"0 0 40px","margin":"0","background":"#F9F8F8","flex":"1"}'>
				...
				<div class="btn" :style='{"padding":"0 0 0 180px","margin":"20px 0 0","flexWrap":"wrap","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#769589","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('systemintro','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
