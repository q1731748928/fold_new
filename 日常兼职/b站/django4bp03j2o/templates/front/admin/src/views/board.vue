			...
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="dongmanxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="dongmanxinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="dongmanxinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"50%","padding":"0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
				...
				<div :style='{"alignContent":"center","padding":"20px 20px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","fontSize":"14px","height":"calc(40% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>动漫信息总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{dongmanxinxiCount}}</div>
						</div>
					</div>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"#2097db","height":"12px"}'></div>
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>动漫番剧总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{dongmanfanjuCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="dongmanxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					<div :style='{"margin":"0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>动漫信息</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="genre" label="类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="directedby" label="导演"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="starring" label="主演"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="lang" label="语言"/>
						</el-table-column>
				...
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="dongmanxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			...
			this.dongmanxinxiChat2();
			this.dongmanxinxiChat3();
			this.dongmanxinxiChat4();
			this.dongmanxinxiChat5();
			this.getdongmanfanjuCount();
		},500)
	})
  },
  methods:{
...
//统计接口1
    dongmanxinxiChat1() {
      this.$nextTick(()=>{
        ...
        var dongmanxinxiChart1 = echarts.init(document.getElementById("dongmanxinxiChart1"),'caravan');
        this.$http({
...
//统计接口2
    dongmanxinxiChat2() {
      this.$nextTick(()=>{
        ...
        var dongmanxinxiChart2 = echarts.init(document.getElementById("dongmanxinxiChart2"),'caravan');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                dongmanxinxiChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dongmanxinxiChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    dongmanxinxiChat3() {
      this.$nextTick(()=>{
        ...
        var dongmanxinxiChart3 = echarts.init(document.getElementById("dongmanxinxiChart3"),'caravan');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                dongmanxinxiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dongmanxinxiChart3.resize();
                },false);
            }
        });
      })
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'dongmanxinxiChart4');
...
//统计接口5
    dongmanxinxiChat5() {
      this.$nextTick(()=>{
        ...
        var dongmanxinxiChart5 = echarts.init(document.getElementById("dongmanxinxiChart5"),'caravan');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                dongmanxinxiChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    dongmanxinxiChart5.resize();
					},false);
            }
        });
      })
    },
    getdongmanfanjuCount() {
        this.$http({
            url: `dongmanfanju/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.dongmanfanjuCount = data.data
            }
        })
    },
