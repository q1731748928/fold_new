...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderdb0lc4z4 && scrapy crawl "+tableName+"Spider -a databaseName=django4bp03j2o"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django4bp03j2o"
        os.system(cmd)
