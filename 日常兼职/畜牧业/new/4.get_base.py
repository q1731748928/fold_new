...
headers = {
    ...
    "pragma": "no-cache",
    "priority": "u=0, i",
    "referer": "https://gleami.apps.fao.org/baseline_selection",
...
cookies = {
    ...
    "_ga_D1DDJEPMCW": "GS2.1.s1747796148$o1$g1$t1747800373$j0$l0$h0"
}
url = "https://gleami.apps.fao.org/baseline_selection"
data = {
    "csrfmiddlewaretoken": "LvFWZnmJxDCIWGjxlv1E5O68AXs60Cz9Xp4dcRAdhUjfoD0f8tIjhvUoM6GVuPN5",
    "baseline_selection": "",
    "skip_btn": "skip"
}
