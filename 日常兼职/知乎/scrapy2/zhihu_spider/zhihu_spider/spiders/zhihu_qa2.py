...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse(self, response: HtmlResponse, **kwargs):
        ...
        for data in datas:
            ...
            self.headers['x-zse-96'] = str(result)
            self.headers['x-zst-81'] = str(_para)
        while True:
            if next == "" or next == []:
                break
