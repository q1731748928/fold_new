...
class ZhihuSpiderPipeline:
    ...
    def process_item(self, item, spider):
        ...
        sql = "INSERT INTO zhihu_qa2 (excerpt, content, created_time, author_id, voteup_count) VALUES (%s, %s, %s, %s, %s)"
        val = (str(excerpt), str(content), str(created_time), str(author_id), int(voteup_count))
