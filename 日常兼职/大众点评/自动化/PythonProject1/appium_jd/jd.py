...
# 定义点击的目标
el1 = driver.find_element(By.XPATH, '//android.widget.TextView[@resource-id="com.jingdong.app.mall:id/h8"]')
el1.click()
# 点击输入框，清空，并输入
el2 = driver.find_element(By.ID, 'com.jd.lib.search.feature:id/ac8')
el2.clear()
el2.send_keys('辣条')
el3 = driver.find_element(By.ID, 'com.jd.lib.search.feature:id/ab5')
el3.click()
# 获取屏幕尺寸
